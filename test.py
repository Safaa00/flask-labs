...
def create_student():
	with app.app_context():
		student = Student(name='safaa',age='22',username='safaa3', email='safaa@gmail.com', password='123')
...
def update_student():
	with app.app_context():
		student = Student.query.filter_by(username="safaa33").first()
		student.username = 'safaa33'
		db.session.commit()
  		# print(student)
